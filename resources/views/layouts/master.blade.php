        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/producto/listar">Productos</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/categoria/listar">Categorias</a>
              </li>
              <li class="nav-item">
                <a class="nav-link active" aria-current="page" href="/sucursal/listar">Sucursales</a>
              </li>
              ...
              <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="/stock/editar">Editar Stock</a></li>
                <li><a class="dropdown-item" href="/stock/listar">Listar Stocks</a></li>
              </ul>
            </li>
            </ul>
